...
/**
 * \Playground\Admin\Resource\Http\Requests\Setting\IndexRequest
 */
class IndexRequest extends BaseIndexRequest
{
    ...
    protected array $paginationIds = [
        ...
        'setting_type' => ['column' => 'setting_type', 'label' => 'Setting Type', 'type' => 'string', 'nullable' => true],
    ];
    ...
    protected array $sortable = [
        ...
        'setting_type' => ['column' => 'setting_type', 'label' => 'Setting Type', 'type' => 'string'],
